module.exports = {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1294017441646772406", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#2B2D31",
    TRANSPARENT: "#2B2D31",
  ...
  PRESENCE: {
    ...
    MESSAGE: "preparing for DA OPPS | handmade with vro ❤️", // Your bot status message
  },
